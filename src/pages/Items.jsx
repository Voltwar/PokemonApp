        ...
        <>
            <Mui.Card sx={{ backgroundColor: '#ADD8E6', opacity: '1', margin: 6 }}>
                ...
                <Mui.CardActions sx={{ display: 'flex', flexWrap: 'nowrap', justifyContent: 'space-between' }}>
                    <Mui.Button
                        variant="contained"
                        disabled={R.isNil(R.propOr(null, 'previous', items))}
                        onClick={() => setRequestUrl(R.propOr('', 'previous', items))}
                    >
                        Prev
                    </Mui.Button>
                    <Mui.Button
                        variant="contained"
                        disabled={R.isNil(R.propOr(null, 'next', items))}
                        onClick={() => setRequestUrl(R.propOr('', 'next', items))}
                    >
                        Next
                    </Mui.Button>
                </Mui.CardActions>
