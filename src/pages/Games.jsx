    ...
    <Mui.Card>
      ...
      <Mui.CardContent>
        ...
        <Mui.CardActions sx={{display: "flex", flexWrap: 'nowrap', justifyContent: 'space-between'}}>
          <Mui.Button variant="contained" disabled={R.isNil(R.propOr(null, 'previous', games))} onClick={() => setRequestUrl(R.propOr('', 'previous', games))}>Prev</Mui.Button>
          <Mui.Button variant="contained" disabled={R.isNil(R.propOr(null, 'next', games))} onClick={() => setRequestUrl(R.propOr('', 'next', games))}>Next</Mui.Button>
        </Mui.CardActions>
    </Mui.Card>
    </>  
  );
