    ...
    <Mui.Card>
      ...
      <Mui.CardContent>
        ...
        <Mui.CardActions sx={{display: "flex", flexWrap: 'nowrap', justifyContent: 'space-between'}}>
          <Mui.Button variant="contained" disabled={R.isNil(R.propOr(null, 'previous', moves))} onClick={() => setRequestUrl(R.propOr('', 'previous', moves))}>Prev</Mui.Button>
          <Mui.Button variant="contained" disabled={R.isNil(R.propOr(null, 'next', moves))} onClick={() => setRequestUrl(R.propOr('', 'next', moves))}>Next</Mui.Button>
        </Mui.CardActions>
    </Mui.Card>
    </>  
  );
