        ...
        <>
            <Mui.Card sx={{ backgroundColor: '#ADD8E6', opacity: '1', margin: 6 }}>
                ...
                <Mui.CardActions sx={{ display: 'flex', flexWrap: 'nowrap', justifyContent: 'space-between' }}>
                    <Mui.Button
                        variant="contained"
                        disabled={R.isNil(R.propOr(null, 'previous', berries))}
                        onClick={() => setRequestUrl(R.propOr('', 'previous', berries))}
                    >
                        Prev
                    </Mui.Button>
                    <Mui.Button
                        variant="contained"
                        disabled={R.isNil(R.propOr(null, 'next', berries))}
                        onClick={() => setRequestUrl(R.propOr('', 'next', berries))}
                    >
                        Next
                    </Mui.Button>
                </Mui.CardActions>
